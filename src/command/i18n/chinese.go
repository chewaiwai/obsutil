...
func (messageBuilderCn) setChattriStrings() {
	...
	message.SetString(language.Chinese, "the ACL that can be specified for a bucket or objects, possible values are [private|public-read|public-read-write]", "桶或对象的预定义访问策略。支持的值：[private|public-read|public-read-write]")
...
func (messageBuilderCn) setCpStrings() {
	...
	message.SetString(language.Chinese, "the ACL of each object to be uploaded or copied, possible values are [private|public-read|public-read-write]", "上传/复制对象时可指定的预定义访问策略。支持的值：[private|public-read|public-read-write]")
...
func (messageBuilderCn) setMvStrings() {
	...
	message.SetString(language.Chinese, "the ACL of each object to be moved, possible values are [private|public-read|public-read-write]", "移动对象时可指定的预定义访问策略。支持的值：[private|public-read|public-read-write]")
