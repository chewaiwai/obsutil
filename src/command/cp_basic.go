...
func initCp() command {
	...
	c.help = func() {
		...
		printf("")
		p.Printf("Syntax 1:")
		printf("%2s%s", "", "obsutil cp file_url|folder_url obs://bucket[/key] [-dryRun] [-link] [-u] [-vlength] [-vmd5] [-p=1] [-threshold=52428800] [-acl=xxx] [-sc=xxx] [-meta=aaa:bbb#ccc:ddd] [-ps=5242880] [-cpd=xxx] [-fr] [-arcDir=xxx] [-o=xxx] [-config=xxx]")
		printf("")
		p.Printf("Syntax 2:")
		printf("%2s%s", "", "obsutil cp folder_url obs://bucket[/prefix] -r [-dryRun] [-link] [-f] [-u] [-vlength] [-vmd5] [-flat] [-j=1] [-p=1] [-threshold=52428800] [-acl=xxx] [-sc=xxx] [-meta=aaa:bbb#ccc:ddd] [-ps=5242880] [-include=*.xxx] [-exclude=*.xxx] [-arcDir=xxx] [-timeRange=time1-time2] [-o=xxx] [-cpd=xxx] [-config=xxx]")
		printf("")
		p.Printf("Syntax 3:")
		printf("%2s%s", "", "obsutil cp file1_url,folder1_url|filelist_url obs://bucket[/prefix] -msm=1 [-r] [-dryRun] [-link] [-f] [-u] [-vlength] [-vmd5] [-flat] [-j=1] [-p=1] [-threshold=52428800] [-acl=xxx] [-sc=xxx] [-meta=aaa:bbb#ccc:ddd] [-ps=5242880] [-include=*.xxx] [-exclude=*.xxx] [-arcDir=xxx] [-timeRange=time1-time2] [-o=xxx] [-cpd=xxx] [-config=xxx]")
		printf("")
		p.Printf("Syntax 4:")
		printf("%2s%s", "", "obsutil cp obs://bucket/key file_url|folder_url [-dryRun] [-tempFileDir=xxx] [-u] [-vlength] [-vmd5] [-p=1] [-threshold=52428800] [-versionId=xxx] [-ps=5242880] [-cpd=xxx] [-fr] [-o=xxx] [-config=xxx]")
		printf("")
		p.Printf("Syntax 5:")
		printf("%2s%s", "", "obsutil cp obs://bucket[/prefix] folder_url -r [-dryRun] [-tempFileDir=xxx] [-f] [-u] [-vlength] [-vmd5] [-flat] [-j=1] [-p=1] [-threshold=52428800] [-ps=5242880] [-include=*.xxx] [-exclude=*.xxx] [-timeRange=time1-time2] [-o=xxx] [-cpd=xxx] [-config=xxx]")
		printf("")
		p.Printf("Syntax 6:")
		printf("%2s%s", "", "obsutil cp obs://srcbucket/key obs://dstbucket/[dest] [-dryRun] [-u] [-crr] [-vlength] [-vmd5] [-p=1] [-threshold=52428800] [-versionId=xxx] [-acl=xxx] [-sc=xxx] [-meta=aaa:bbb#ccc:ddd] [-ps=5242880] [-cpd=xxx] [-fr] [-o=xxx] [-config=xxx]")
		printf("")
		p.Printf("Syntax 7:")
		printf("%2s%s", "", "obsutil cp obs://srcbucket[/src_prefix] obs://dstbucket[/dest_prefix] -r [-dryRun] [-f] [-u] [-crr] [-vlength] [-vmd5] [-flat] [-j=1] [-p=1] [-threshold=52428800] [-acl=xxx] [-sc=xxx] [-meta=aaa:bbb#ccc:ddd] [-ps=5242880] [-include=*.xxx] [-exclude=*.xxx] [-timeRange=time1-time2] [-o=xxx] [-cpd=xxx] [-config=xxx]")
		printf("")
		p.Printf("Syntax 8:")
		printf("%2s%s", "", "obsutil cp -recover=xxx [-dryRun] [-crr] [-f] [-u] [-vlength] [-vmd5] [-j=1] [-p=1] [-threshold=52428800] [-acl=xxx] [-sc=xxx] [-meta=aaa:bbb#ccc:ddd] [-ps=5242880] [-include=*.xxx] [-exclude=*.xxx] [-arcDir=xxx] [-timeRange=time1-time2] [-tempFileDir=xxx] [-o=xxx] [-cpd=xxx] [-config=xxx]")
		printf("")
